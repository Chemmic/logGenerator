...
public class ExtendedTailer implements Runnable {
     ...
     */
    private final ExtendedTailerListener listener;
     ...
     */
    public ExtendedTailer(final File file, final ExtendedTailerListener listener) {
     ...
     */
    public ExtendedTailer(final File file, final ExtendedTailerListener listener, final long delayMillis) {
     ...
     */
    public ExtendedTailer(final File file, final ExtendedTailerListener listener, final long delayMillis, final boolean end) {
     ...
     * @param bufSize Buffer size
     */
    public ExtendedTailer(final File file, final Charset cset, final ExtendedTailerListener listener, final long delayMillis,
     ...
     */
    public static ExtendedTailer create(final File file, final ExtendedTailerListener listener, final long delayMillis,
     ...
     * @return The new tailer
     */
    public static ExtendedTailer create(final File file, final Charset charset, final ExtendedTailerListener listener,
                                final long delayMillis, final boolean end, final boolean reOpen
            ,final int bufSize) {
        final ExtendedTailer tailer = new ExtendedTailer(file, charset, listener, delayMillis, end, reOpen, bufSize);
     ...
     * @return The new tailer
     */
    public static ExtendedTailer create(final File file, final ExtendedTailerListener listener) {
